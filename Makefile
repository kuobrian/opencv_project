...
CMAKE_COMMAND = C:\cmake-3.21.3-windows-x86_64\bin\cmake.exe

# The command to remove a file.
RM = C:\cmake-3.21.3-windows-x86_64\bin\cmake.exe -E rm -f
...
package: preinstall
	...
	C:\cmake-3.21.3-windows-x86_64\bin\cpack.exe --config ./CPackConfig.cmake
.PHONY : package
...
test:
	...
	C:\cmake-3.21.3-windows-x86_64\bin\ctest.exe --force-new-ctest-process $(ARGS)
.PHONY : test
...
edit_cache:
	...
	C:\cmake-3.21.3-windows-x86_64\bin\cmake-gui.exe -S$(CMAKE_SOURCE_DIR) -B$(CMAKE_BINARY_DIR)
.PHONY : edit_cache
...
rebuild_cache:
	...
	C:\cmake-3.21.3-windows-x86_64\bin\cmake.exe --regenerate-during-build -S$(CMAKE_SOURCE_DIR) -B$(CMAKE_BINARY_DIR)
.PHONY : rebuild_cache
